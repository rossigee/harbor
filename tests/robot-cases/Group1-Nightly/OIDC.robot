...
Test Case - OIDC Group Filter
    ...
    # Delete all groups
    Run Keyword If  '${total}' != '0 items'  Run Keywords  Retry Element Click  ${group_select_all_checkbox_xpath}  AND  Retry Button Click  //button[contains(.,'Delete')]  AND  Retry Button Click  //button[contains(.,'DELETE')]
